    ...
    <AnimatePresence>
      {isLoading ? (
        <motion.div 
          ...
          className="fixed inset-0 bg-[#030307] flex flex-col items-center justify-center z-[100]"
        >
          <motion.div 
            initial={{ width: 0 }}
            animate={{ width: 200 }}
          ...
          >
            <motion.div 
              ...
              className="absolute top-0 w-8 h-[1px] bg-cyan-400 shadow-[0_0_10px_#00f2ff]"
            />
          </motion.div>
          <span className="mt-6 text-[8px] font-bold tracking-[1.5em] uppercase text-white/30">System Sync</span>
        </motion.div>
      ) : (
